...
* zde se vyhodnocuj° intern° hotkeje Clockñ
	move.b	hotshift(PC),d1	jsou povolenÇ intern° hotkeje Clockñ?
	beq	.ehc		0 = nepovolenÇ
	cmp.b	d1,d2		drë°m kombinaci pro hotkey?
	bne	.ehc
...
.hotk1	cmp.b	(a0,d1),d0
	dbeq	d1,.hotk1
	tst	d1
	bmi.s	.ehc		ë†dn† z horkòch kl†ves
...
.shall	cmp.b	#%1100,d2		porovnej s Alt+Control
	...
	move.b	myKbshift,act_shift	zap°®u stav p©e©azovaáñ
...
* zde kontrola na kuk na Clocky
	cmp.b	d2,d1		je stlaáena kombinace Kukkeje?
	beq.s	.juk
...
tut_tab_end:
	...
	ifne	ENGLISH
infotext	dc.b	13,10,27,'p',"  Clockyø version 3.11beta  2000/12/10 ",27,'q',13,10
	dc.b	       "     (c) 1991-2000  Petr Stehlik",13,10,10,0
unintext	dc.b	"Clocky has been deactivated and removed.",13,10,0
	else
infotext	dc.b	13,10,27,'p',"  Clockyø verze 3.11beta  10.12.2000 ",27,'q',13,10
